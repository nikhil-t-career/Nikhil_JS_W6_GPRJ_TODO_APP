...
var taskInput = document.getElementById("add-task"); // add-task
...
var addTask = function () {
  ...
  var listItem = createNewTaskElement(listItemName); // Create a new list item with the text from #add-task
